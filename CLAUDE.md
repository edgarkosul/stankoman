...
Перевод запроса в латиницу — `App\Support\Search\LatinQuery`, один класс
на витрину и на бота (52 бренда из 60 пишутся латиницей, а ищут их кириллицей).
Второй реализации не заводить: у донора эти две разошлись молча, и поиск
в шапке находил семь компрессоров Hansmann, а бот на тот же запрос отвечал
«не нашлось».
