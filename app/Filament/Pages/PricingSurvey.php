    ...
    public static function questions(): array
    {
        return [
            ...
            [
                ...
                'now' => 'Здесь поправлю: такая загрузка перезаписывает «Цена на сайт» ценой поставщика, если при запуске не выбрать «Только выбранные поля» без «Цена». Опт, курс и наценку она не трогает вообще. Выбор полей при запуске сделан намеренно: одному поставщику можно обновить только наличие, другому — ещё и цены.',
                'options' => [
                    [
                        'key' => 'А',
                        'title' => 'Решать при каждом запуске',
                        'desc' => 'Оставляем как сейчас: перед загрузкой вы отмечаете, какие поля обновлять — цену, наличие, картинки.',
                        'effect' => 'Гибко: можно обновить только наличие и не тронуть ваши цены, а можно наоборот. Ничего не меняю.',
                        'recommended' => true,
                    ],
                    [
                        'key' => 'Б',
                        'title' => 'Жёстко защитить ручные цены',
                        'desc' => 'Ввожу правило: если у товара заполнены «Цена опт» и «Наценка» — прайс поставщика цену на сайте не трогает никогда.',
                        'effect' => 'Обратная сторона: обновить цену от поставщика у таких товаров станет нельзя даже тогда, когда это нужно — галочка «Цена» на них перестанет работать.',
                    ],
                ],
            ],
            [
