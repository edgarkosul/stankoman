 ...
 *
 * Гостю скидку не применяем к итоговой цене в корзине и фиде. На карточке
 * товара скидочная сумма может показываться как будущая цена после регистрации.
 * В оформлении заказа скидка также включается, если человек ставит галку
 * «завести личный кабинет» — там передаётся $forAuthenticated явно.
 */
