...
test('edit setting page saves string settings into value column', function (string $key, string $field, string $value): void {
    ...
    'company inn' => ['company.inn', 'inn_value', '231102927496'],
    'company ogrn' => ['company.ogrn', 'ogrn_value', '1234567890123'],
    'company ogrnip' => ['company.ogrnip', 'ogrnip_value', '123456789012345'],
    ...
    'company correspondence addr' => ['company.correspondence_addr', 'correspondence_addr_value', 'г. Краснодар, а/я 100'],
