...
test('russian auth translations include inline auth strings and auth route labels', function (): void {
    ...
    expect($translations)->toBeArray()
        ...
        ->and($translations['Email'])->toBe('Адрес электронной почты')
        ->and($translations['Verify Email Address'])->toBe('Подтвердите адрес электронной почты')
        ->and($translations['Reset password'])->toBe('Сбросить пароль')
        ->and($translations['Please enter your new password below'])->toBe('Введите новый пароль ниже')
